...
<style>
    ...
    <div class="container-fluid px-4">
        ...
        @include('screens.management.OrganisationAdmin.views.org_groups_view')
...
$(document).ready(function() {
    $('.pending-badge').click(function(e) {
        ...
        if (confirm('Are you sure you want to approve this group?')) {
            ...
            $.ajax({
                url: '/organisation/approve-group/' + groupid,
                method: 'POST',
                data: {
                    _token: '{{ csrf_token() }}'
                },
    ...
    $('.active-badge').click(function(e) {
        ...
        if (confirm('Are you sure you want to suspend this group?')) {
            ...
            $.ajax({
                url: '/organisation/suspend-group/' + groupid,
                method: 'POST',
                data: {
                    _token: '{{ csrf_token() }}'
                },
    ...
    $('.delete-badge').click(function(e) {
        ...
        if (confirm('Are you sure you want to delete this group?')) {
            ...
            $.ajax({
                url: '/organisation/delete-group/' + groupid,
                method: 'POST',
                data: {
                    _token: '{{ csrf_token() }}'
                },
